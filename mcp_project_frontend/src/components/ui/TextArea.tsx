    ...
    return (
      <div className={cn('space-y-2', containerClassName)}>
        ...
        <textarea
          ...
          ref={ref}
          className={cn(
            'w-full rounded-md border bg-background px-3 py-2 text-sm placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 transition-shadow transition-colors duration-150 hover:border-primary active:scale-95 disabled:cursor-not-allowed disabled:opacity-50',
